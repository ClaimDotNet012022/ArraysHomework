...
namespace ArraysHomework
{
    ...
    public class ArraysHomework
    {
        ...
        public void Arrays()
        {
            ...
            string tempValue = swapMyValues[0]; // which would be "first"
            swapMyValues[0] = swapMyValues[swapMyValues.Length - 1];
            swapMyValues[swapMyValues.Length - 1] = tempValue;
            ...
            {
                int j = i + array1.Length;              // refers to previous for
                combined[j] = array2[i];                // and combines them here!
            }
        ...
        public void Lists()
        {
            ...
            string tempValue1 = swapMyValues[0];
            swapMyValues[0] = swapMyValues[swapMyValues.Count - 1];
            swapMyValues[swapMyValues.Count - 1] = tempValue1;
            ...
            bool containsNumTwo = sortMe.Contains(2);   // ??
            

            // BONUS Remove all of sort mes values

            sortMe.Clear();     // i feel like this is too simple...
