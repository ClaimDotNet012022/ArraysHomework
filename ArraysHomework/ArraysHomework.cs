...
namespace ArraysHomework
{
    ...
    public class ArraysHomework
    {
        ...
        public void Arrays()
        {
            ...
            //swapMyValues[0] = swapMyValues[swapMyValues.Length - 1]; // { "last", "middle", "last" }
            //swapMyValues[swapMyValues.Length - 1] = swapMyValues[0]; // { "last", "middle", "last" } // WRONG!

            string temp = swapMyValues[0];  // "first"
            swapMyValues[0] = swapMyValues[swapMyValues.Length - 1];    // { "last", "middle", "last" }, but temp == "first"
            swapMyValues[swapMyValues.Length - 1] = temp;               // { "last", "middle", "first" }

            //(swapMyValues[swapMyValues.Length - 1], swapMyValues[0]) = (swapMyValues[0], swapMyValues[swapMyValues.Length - 1]);
            // The above is implicitly doing all this:
            //System.Tuple<string, string> tuple = new System.Tuple<string, string>(swapMyValues[0], swapMyValues[swapMyValues.Length - 1]);
            //swapMyValues[swapMyValues.Length - 1] = tuple.Item1;
            //swapMyValues[0] = tuple.Item2;
        ...
        public void Lists()
        {
            ...
            // List<char> copiedList = copyMe; // Does not copy. Creates a reference to the same List.

            //List<char> copiedList = new List<char>();
            //for (int i = 0; i < copiedList.Count; i++)
            //{
            //    copiedList.Add(copyMe[i]);
            //}
            ...
            string temp = swapMyValues[0];  // "first"
            swapMyValues[0] = swapMyValues[swapMyValues.Count - 1];    // { "last", "middle", "last" }, but temp == "first"
            swapMyValues[swapMyValues.Count - 1] = temp;               // { "last", "middle", "first" }
            ...
            //copy2 = copy2.Concat(copy1).ToList();
